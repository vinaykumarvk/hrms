...
The gate `ph-37a.sh` enforces **total coverage ≥ 31.1%** and **implemented routes ≥ 411**. Coverage can only
...
continuous-feedback check-ins/reads + 360-feedback rate/release/read + signature reads — 7 real,

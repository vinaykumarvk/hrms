...
The gate `ph-37a.sh` enforces **total coverage ≥ 37%** and **implemented routes ≥ 489**. Coverage can only
...
G04 X.3 outbound-integration connector lifecycle + leave→SR relay enqueue/dead-letter reads — 7 real,

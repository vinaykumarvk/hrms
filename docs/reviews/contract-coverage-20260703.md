...
The gate `ph-37a.sh` enforces **total coverage ≥ 30.5%** and **implemented routes ≥ 404**. Coverage can only
...
**404 / 30.5%** (PH-39A: APAR PIP lifecycle + probation-confirmation + report-period/goal-snapshot reads —
7 real, service-tested operations wired to the kernel).

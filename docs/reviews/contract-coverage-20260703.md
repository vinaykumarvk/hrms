...
The gate `ph-37a.sh` enforces **total coverage ≥ 40.2%** and **implemented routes ≥ 532**. Coverage can only
...
(settle → approve SoD) + recovery/loan/hold reads — 6 real, service-tested operations wired to the kernel).

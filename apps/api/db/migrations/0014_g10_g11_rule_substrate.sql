...
CREATE TYPE g10_component_category AS ENUM ('EARNING','DEDUCTION','PERQUISITE','EMPLOYER_CONTRIBUTION','ROUNDING_ADJUSTMENT','LEAVE_ENCASHMENT');
...
CREATE TYPE g10_rate_table_type    AS ENUM ('DA_RATE','HRA_CLASS','PT_SLAB','TAX_SLAB','NPS_RATE','GPF_RATE','GRATUITY_RATE','OTHER');

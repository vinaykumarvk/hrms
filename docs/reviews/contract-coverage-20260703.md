...
The gate `ph-37a.sh` enforces **total coverage ≥ 32.5%** and **implemented routes ≥ 430**. Coverage can only
...
vendor-empanelment decisions — 9 real, service-tested operations wired to the kernel).

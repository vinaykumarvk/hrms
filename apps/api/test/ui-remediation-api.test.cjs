...
test("UIR-04 existing workflow API contract covers list and supported task verbs", async () => {
...
test("UIR-04 unsafe web-client operations preserve Idempotency-Key", async () => {
...
test("UIR-04 unsupported APIs remain absent and explicitly quarantined", async () => {

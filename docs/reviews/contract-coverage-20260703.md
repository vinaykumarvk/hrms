...
The gate `ph-37a.sh` enforces **total coverage ≥ 31.8%** and **implemented routes ≥ 421**. Coverage can only
...
sponsorship + service-bond lifecycle — 10 real, service-tested operations wired to the kernel).

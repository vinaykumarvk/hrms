...
The gate `ph-37a.sh` enforces **total coverage ≥ 34.9%** and **implemented routes ≥ 462**. Coverage can only
...
(PH-47A: G11 PDA go-live lifecycle + grievance close + pensioner bank-account verification — 6 real,

  ...
  const routes: RouteDefinition[] = [
    {
      ...
      handler: async (context) => {
        ...
        return created({
          session: await context.services.training.createSession(context.actor, {
    ...
    },
    {
      ...
      handler: async (context) => ok({ items: await context.services.training.listSessions(context.scope).map(toWireSession) }),
    },
    {
      method: "GET",
      ...
      protected: true,
      permission: "g07.training.read",
      handler: async (context) => ok({ items: await context.services.training.listMyNominations(context.actor, requiredParam(context.params, "id")).map(toWireNomination) }),
    },
    {
      method: "POST",
      ...
      handler: async (context) => {
        ...
        return created({
          nomination: toWireNomination(
            await context.services.training.nominate(context.actor, {
    ...
    },
    {
      ...
      requiresIdempotencyKey: true,
      handler: async (context) =>
        accepted({ nomination: toWireNomination(await context.services.training.approveNomination(context.actor, requiredParam(context.params, "id"))) }),
    },
    {
      method: "POST",
      ...
      handler: async (context) => {
        const body = readBodyRecord(context.request.body);
        const result = await context.services.training.completeNomination(context.actor, requiredParam(context.params, "id"), {
    ...
    },
    {
      ...
      protected: true,
      permission: "g07.training.read",
      handler: async (context) => ok(await context.services.training.summary(context.scope)),
    },
    // ---------------------------------------------------------------------------------
    ...
    // ---------------------------------------------------------------------------------
    {
      ...
      handler: async (context) => {
        const body = readBodyRecord(context.request.body);
        return created({
          skillCategory: await context.services.training.defineSkillCategory(context.actor, {
    ...
    },
    {
      ...
      handler: async (context) => {
        const body = readBodyRecord(context.request.body);
        return created({
          skill: await context.services.training.defineSkill(context.actor, {
    ...
    },
    {
      ...
      handler: async (context) => {
        const body = readBodyRecord(context.request.body);
        return created({
          competency: await context.services.training.defineCompetency(context.actor, {
            code: requiredString(body, "code"),
            name: requiredString(body, "name"),
    ...
    },
    {
      ...
      handler: async (context) => {
        const body = readBodyRecord(context.request.body);
        return created({
          competencyModel: await context.services.training.defineCompetencyModel(context.actor, {
            code: requiredString(body, "code"),
            name: requiredString(body, "name"),
    ...
    },
    {
      ...
      handler: async (context) => {
        const body = readBodyRecord(context.request.body);
        return created({
          employeeSkill: await context.services.training.recordEmployeeSkill(context.actor, {
            employeeId: optionalString(body, "employeeId") ?? ph03Ids.employee,
    ...
    // ---------------------------------------------------------------------------------
    {
      ...
      handler: async (context) => {
        const body = readBodyRecord(context.request.body);
        return created(
          await context.services.training.runSkillGapAnalysis(context.actor, {
            employeeId: optionalString(body, "employeeId") ?? ph03Ids.employee,
    ...
    },
    {
      ...
      handler: async (context) =>
        ok({
          gapContract: await context.services.training.getGapContract(context.scope, {
    ...
    // ---------------------------------------------------------------------------------
    {
      ...
      handler: async (context) => {
        const body = readBodyRecord(context.request.body);
        return accepted(await context.services.training.runCertExpiryJob(context.actor, { asOf: requiredString(body, "asOf") }));
      },
    },
    // ---------------------------------------------------------------------------------
    ...
    // ---------------------------------------------------------------------------------
    {
      ...
      handler: async (context) => {
        const body = readBodyRecord(context.request.body);
        return created({
          campaign: await context.services.training.createCampaign(context.actor, {
            code: requiredString(body, "code"),
            name: requiredString(body, "name"),
            programCode: requiredString(body, "programCode"),
    ...
    },
    {
      ...
      handler: async (context) => {
        const body = readBodyRecord(context.request.body);
        return accepted({
          targets: await context.services.training.addCampaignTargets(context.actor, requiredParam(context.params, "id"), {
    ...
    },
    {
      ...
      handler: async (context) => {
        const body = readBodyRecord(context.request.body);
        return accepted({
          escalated: await context.services.training.escalateCampaignTargets(context.actor, requiredParam(context.params, "id"), {
    ...
    // PH-31C — G07 vendor/external-trainer empanelment (route exposure for the PH-20A engine).
    {
      ...
      handler: async (context) => {
        const body = readBodyRecord(context.request.body);
        return created({
          empanelment: await context.services.vendorEmpanelment.applyForEmpanelment(context.actor, {
    ...
    },
    {
      ...
      handler: async (context) => {
        const body = readBodyRecord(context.request.body);
        return created({
          lrs: await context.services.lmsIntegration.registerLrs(context.actor, {
            name: requiredString(body, "name"),
    ...
    // waive; reads). Money is integer paise; bond recovery is pro-rata on unserved months.
    {
      ...
      handler: async (context) => {
        const body = readBodyRecord(context.request.body);
        return created({
          sponsorship: await context.services.training.createSponsorship(context.actor, {
    ...
    },
    {
      ...
      unsafe: true,
      requiresIdempotencyKey: true,
      handler: async (context) => accepted({ sponsorship: await context.services.training.sanctionSponsorship(context.actor, requiredParam(context.params, "id")) }),
    },
    {
      method: "POST",
      ...
      handler: async (context) => {
        const body = readBodyRecord(context.request.body);
        return accepted({ sponsorship: await context.services.training.activateSponsorshipBond(context.actor, requiredParam(context.params, "id"), { completionDate: requiredString(body, "completionDate") }) });
      },
    },
    {
      method: "POST",
      ...
      handler: async (context) => {
        const body = readBodyRecord(context.request.body);
        return accepted({ sponsorship: await context.services.training.fulfilSponsorshipBond(context.actor, requiredParam(context.params, "id"), { asOf: requiredString(body, "asOf") }) });
      },
    },
    {
      method: "POST",
      ...
      handler: async (context) => {
        const body = readBodyRecord(context.request.body);
        return accepted({ sponsorship: await context.services.training.markSponsorshipBreached(context.actor, requiredParam(context.params, "id"), { breachDate: requiredString(body, "breachDate") }) });
      },
    },
    {
      method: "POST",
      ...
      unsafe: true,
      requiresIdempotencyKey: true,
      handler: async (context) => created({ cost: await context.services.training.emitBondRecoveryCost(context.actor, requiredParam(context.params, "id")) }),
    },
    {
      method: "POST",
      ...
      unsafe: true,
      requiresIdempotencyKey: true,
      handler: async (context) => accepted({ sponsorship: await context.services.training.markSponsorshipRecovered(context.actor, requiredParam(context.params, "id")) }),
    },
    {
      method: "POST",
      ...
      handler: async (context) => {
        const body = readBodyRecord(context.request.body);
        return accepted({ sponsorship: await context.services.training.waiveSponsorship(context.actor, requiredParam(context.params, "id"), { reason: requiredString(body, "reason") }) });
      },
    },
    {
      method: "GET",
      ...
      handler: async (context) => ok({ sponsorship: await context.services.training.getSponsorship(context.scope, requiredParam(context.params, "id")) }),
    },
    {
      method: "GET",
      ...
      protected: true,
      permission: "g07.sponsorship.read",
      handler: async (context) => ok({ items: await context.services.training.listSponsorshipCosts(context.scope, requiredParam(context.params, "id")) }),
    },
    ...
    // SoD; VAL-G07-CREDREF; VERIFIED significant credential posts to G12) + reads.
    {
      ...
      handler: async (context) => {
        const body = readBodyRecord(context.request.body);
        return created(
          await context.services.training.captureExternalCredential(context.actor, {
            employeeId: requiredString(body, "employeeId"),
            title: requiredString(body, "title"),
    ...
    },
    {
      ...
      handler: async (context) => {
        const body = readBodyRecord(context.request.body);
        return accepted({
          verification: await context.services.training.reviewCredentialEvidence(context.actor, requiredParam(context.params, "id"), {
    ...
    },
    {
      ...
      handler: async (context) => {
        const body = readBodyRecord(context.request.body);
        return accepted(
          await context.services.training.verifyExternalCredential(context.actor, requiredParam(context.params, "id"), {
    ...
    },
    {
      ...
      handler: async (context) => {
        const body = readBodyRecord(context.request.body);
        return accepted(
          await context.services.training.rejectExternalCredential(context.actor, requiredParam(context.params, "id"), {
    ...
    },
    {
      ...
      handler: async (context) => ok({ credential: await context.services.training.getExternalCredential(context.scope, requiredParam(context.params, "id")) }),
    },
    {
      method: "GET",
      ...
      protected: true,
      permission: "g07.credential.read",
      handler: async (context) => ok({ items: await context.services.training.listCredentialVerifications(context.scope, requiredParam(context.params, "id")) }),
    },
    // PH-42A — vendor-empanelment review/decide (4-eyes) + read (applyForEmpanelment already routed).
    {
      ...
      unsafe: true,
      requiresIdempotencyKey: true,
      handler: async (context) => accepted({ empanelment: await context.services.vendorEmpanelment.reviewEmpanelment(context.actor, requiredParam(context.params, "id")) }),
    },
    {
      method: "POST",
      ...
      handler: async (context) => {
        const body = readBodyRecord(context.request.body);
        return accepted({
          empanelment: await context.services.vendorEmpanelment.decideEmpanelment(context.actor, requiredParam(context.params, "id"), {
    ...
    },
    {
      ...
      handler: async (context) => {
        const row = await context.services.vendorEmpanelment.getEmpanelment(context.scope, requiredParam(context.params, "id"));
        if (!row) {
